...
public class PickSickDialogFragment extends DialogFragment {
            ...
            for(final String name : personList) {
                ...
                sickName.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        pListener.onDialogPositiveClick(PickSickDialogFragment.this, name, false);
                        dismiss();
                    }
                });
            ...
            positiveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(name.getText().toString().length() == 0) {
                        ...
                        pListener.onDialogPositiveClick(PickSickDialogFragment.this,
    ...
    public void onAttach(Context context) {
        ...
        pListener = (PickSickDialogFragment.PickSickDialogListener)getActivity();
    }

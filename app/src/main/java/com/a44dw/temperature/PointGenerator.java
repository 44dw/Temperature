...
public class PointGenerator extends AppCompatActivity implements PickSickDialogFragment.PickSickDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(data.hasExtra(MainActivity.EXTRA_FIRST)) {
            PickSickDialogFragment pickSickDialog = new PickSickDialogFragment();
